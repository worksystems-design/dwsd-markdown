...
the peak. The closing count becomes tomorrow's [[Daily Replenishment Order]]. Unlike the
Market Street board, `Incoming` carries no inline pointer — the [[Counter Handover]]
anchors here **outside-in** only, from its own file; both directions render through the
same surface.
